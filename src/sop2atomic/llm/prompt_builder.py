...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "2) A catalogue of 'atomic components' with IDs, names, categories, descriptions and parameters.\n\n"
        ...
        "- If no component fits, use component_id = null and component_name = \"MISSING_COMPONENT\" and describe what is needed.\n\n"
